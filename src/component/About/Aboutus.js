...
import './Aboutus.css';
import child2 from './img/about_4.png';
        ...
        return(
            <div className="maincontainer">
                ...
                <div className="rowcard3">
                    <div className="aboutcard1_3">
                        <div className="card3">
                            <h1 className="head_3">Who is a KRIYATOR?</h1>
                            <br />
                            <p className="detail_3">Creative expert</p>
                        </div>
                    </div>
                    <div className="aboutcard2_3">
                        <img src={child1} />
                    </div>
                </div>
                <div className="rowcard4">
                    <div className="aboutcard1_4">
                        <img src={child2} />
                    </div>
                    <div className="aboutcard2_4">
                        <div className="card4">
