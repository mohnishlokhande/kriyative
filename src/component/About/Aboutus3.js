...
import willing from './img/3_willing.png';
                ...
                <div className="rowcard3">
                    <div className="aboutcard3_1">
                        <div className="card3">
                            ...
                            <br />
                            <div className="arrow">
                                <span><Link to="/about2"><img src={back} alt="back"/></Link><span className="tab"></span><Link to="/about4"><img src={forward} alt="forward"/></Link></span>
                            </div>
                            <br />
                            <br />
                            <div className="icon">
