                ...
                <div className="rowcard3">
                    <div className="aboutcard3_1">
                        <div className="card3">
                            ...
                            <br />
                            <div className="arrow">
                                <span><Link to="/about3"><img src={back} /></Link><span className="tab"></span><Link to="/about5"><img src={forward} /></Link></span>
                            </div>
                            <br />
                            <br />
                            <div className="icon">
                            <span><img src={think }/></span><span className="tab"></span><p className="detail_3">Thinking out of box</p>
                            </div>
                        </div>
                    </div>
