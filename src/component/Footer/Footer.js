                    ...
                    <div className="row justify-content-center">             
                        <div className="col-12 offset-sm-1 col-sm-3">
                            ...
                            <ul className="list-unstyled">
                                <li style={{textAlign: "justify"}} onClick={scrollToTop}><Link to="/pathways">Learning Pathways</Link></li>
                                <li style={{textAlign: "justify"}} onClick={scrollToTop}><Link to="/metho">KRIYA Methodology</Link></li>
                                <li style={{textAlign: "justify"}} onClick={scrollToTop}><Link to="/about">About Us</Link></li>
                                <li style={{textAlign: "justify"}} onClick={scrollToTop}><Link to="/contactus">Contact Us</Link></li>
                            </ul>
                        </div>
                        <div className="col-12 offset-sm-1 col-sm-3">
